...
pub trait ModelsEndpointClient: fmt::Debug + Send + Sync {
    ...
    /// Returns whether this provider should always refresh its model list from the network.
...
impl OpenAiModelsManager {
    ...
    async fn should_refresh_models(&self) -> bool {
        self.endpoint_client.always_refresh_models() || self.endpoint_client.has_command_auth()
    }

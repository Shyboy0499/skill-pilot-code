# @skill-pilot/spcode-responses-api-proxy

<p align="center"><code>npm i -g @skill-pilot/spcode-responses-api-proxy</code> to install <code>codex-responses-api-proxy</code></p>

...
pub enum UpdateAction {
    /// Update via `npm install -g @skill-pilot/spcode@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @skill-pilot/spcode@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@skill-pilot/spcode"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@skill-pilot/spcode"]),

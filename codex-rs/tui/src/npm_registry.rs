...
pub(crate) const PACKAGE_URL: &str = "https://registry.npmjs.org/@skill-pilot%2fspcode";
    ...
    fn version_json(version: &str) -> serde_json::Value {
        serde_json::json!({
            "dist": {
                ...
                "tarball": format!("https://registry.npmjs.org/@skill-pilot/spcode/-/codex-{version}.tgz"),
            }
        })
    }
